...
var homework={
    ...
    addhw:function(item,callback)
    {
        db.query('insert into homework_tbl values(?,?,?,?,?,?,?)',[item.h_id,item.h_subject,item.h_date,item.h_description,item.h_uploadedby,item.h_class,item.h_div],callback);
    },
